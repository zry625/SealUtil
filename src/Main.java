import configuration.SealCircle;
import configuration.SealConfiguration;
import configuration.SealFont;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**************************************************/
        mainFont.setFontText("西安禾德瑞普智能技术有限公司");
        ...
        viceFont.setFontSize(20);
        viceFont.setFontSpace(25.0);
         ...
         * 内环线粗细、半径
         */
        configuration.setInnerCircle(new SealCircle(2, 85, 85));
...
//            File sealFile = new File("C:\\Users\\Administrator\\Desktop\\公章.png");
...
//        }
        ...
        font.setFontSize(120).setBold(true).setFontText("马化腾");
        SealUtil.buildAndStorePersonSeal(300, 16, font, "印", "C:\\Users\\Administrator\\Desktop\\私章1.png");
